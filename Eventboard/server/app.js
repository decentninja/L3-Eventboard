...
// code to run on server at startup
    if (events.find().count() === 0) {
      var stuff= [{name:'Language Cafe - English/French', description:'An event where you can improve your language-skills in a relaxed environment.  Get to know other people with the same interest in language and culture! Lunch is provided.'},
